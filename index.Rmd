...
You will explore and visualise the data using the packages `dplyr` and `ggplot2`, and you can use the following lines of code to install the packages once on your device, then load them in each session:
